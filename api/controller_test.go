...
func TestBulkCreateBadValidate(t *testing.T) {
	body, _ := sonic.Marshal(M{})
	w := ut.PerformRequest(h.Engine, "POST", "/orders/bulk_create",
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestBulkCreate(t *testing.T) {
	...
	cursor, err := x.Db.Collection("orders").
...
func TestBulkCreateEvent(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "POST", "/projects/bulk_create",
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestUpdateByIdBadValidate(t *testing.T) {
	body, _ := sonic.Marshal(M{})
	w := ut.PerformRequest(h.Engine, "PATCH", fmt.Sprintf(`/users/%s`, userId),
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestUpdateByIdEvent(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "PATCH", fmt.Sprintf(`/projects/%s`, projectId),
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestReplaceBadValidate(t *testing.T) {
	body, _ := sonic.Marshal(M{})
	w := ut.PerformRequest(h.Engine, "PUT", fmt.Sprintf(`/$$$$/%s`, userId),
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestReplaceBadTransform(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "PUT", u.RequestURI(),
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestReplace(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "PUT", fmt.Sprintf(`/users/%s`, userId),
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestReplaceEvent(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "PUT", fmt.Sprintf(`/projects/%s`, projectId),
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestDeleteBadValidate(t *testing.T) {
	w := ut.PerformRequest(h.Engine, "DELETE", fmt.Sprintf(`/$$$$/%s`, userId),
		&ut.Body{},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestDelete(t *testing.T) {
	w := ut.PerformRequest(h.Engine, "DELETE", fmt.Sprintf(`/users/%s`, userId),
		&ut.Body{},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestDeleteEvent(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "DELETE", fmt.Sprintf(`/projects/%s`, projectId),
		&ut.Body{},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestBulkDelete(t *testing.T) {
	...
	n, err := x.Db.Collection("orders").CountDocuments(context.TODO(), bson.M{"_id": bson.M{"$in": ids}})
	assert.NoError(t, err)
...
func TestBulkDeleteEvent(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "POST", "/projects/bulk_delete",
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestSortBadValidate(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "POST", "/orders/sort",
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
...
func TestSortEvent(t *testing.T) {
	...
	w := ut.PerformRequest(h.Engine, "POST", "/projects/sort",
		&ut.Body{Body: bytes.NewBuffer(body), Len: len(body)},
		ut.Header{Key: "content-type", Value: "application/json"},
	)
	resp := w.Result()
